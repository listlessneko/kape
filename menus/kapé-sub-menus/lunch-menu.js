...
const lunch = kapéItems.categories
  .find(category => category.name === 'Food')?.types
  .find(type => type.name === 'Lunch');

export const customId = 'kapé-lunch-sub-menu';
export const content = lunch.content;

const selectMenu = new StringSelectMenuBuilder()
  .setCustomId(customId)
  .setPlaceholder(lunch.placeholder)

for (let i of lunch.items) {
