...
const juices = ingredients.groups.find(group => group.name === 'Juices');

export const customId = juices.custom_id + '-sub-menu';
export const content = juices.content;

const selectMenu = new StringSelectMenuBuilder()
  .setCustomId(customId)
  .setPlaceholder(juices.placeholder)

for (let item of juices.items) {
